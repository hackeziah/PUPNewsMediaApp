            ...
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               <ul class="pagination pull-right">
                <li><?= $this->tag->linkTo(['user/announcements/announcement', 'First']) ?></li>
                <li><?= $this->tag->linkTo(['user/announcements/announcement?page=' . $annouces->before, 'Previous']) ?></li>
                <li><?= $this->tag->linkTo(['user/announcements/announcement?page=' . $annouces->next, 'Next']) ?></li>
                <li><?= $this->tag->linkTo(['user/announcements/announcement?page=' . $annouces->last, 'Last']) ?></li>
              </ul>
            </div>
          </div>
        </div>
