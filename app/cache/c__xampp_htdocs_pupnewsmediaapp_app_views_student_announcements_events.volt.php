              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                 ...
                 <ul class="pagination pull-right">
                  <li><?= $this->tag->linkTo(['admin/manageevents/events', 'First']) ?></li>
                  <li><?= $this->tag->linkTo(['admin/manageevents/events?page=' . $events->before, 'Previous']) ?></li>
                  <li><?= $this->tag->linkTo(['admin/manageevents/events?page=' . $events->next, 'Next']) ?></li>
                  <li><?= $this->tag->linkTo(['admin/manageevents/events?page=' . $events->last, 'Last']) ?></li>
                </ul>
              </div>
            </div>
          </div>
  ...
  function detailevents(event_id)
  {
   // save_method = 'edit';
      ...
      $.ajax({
        ...
        url : "<?= $this->url->get('user/announcements/detailevents') ?>/" + event_id,
        type: "GET",
        dataType: "JSON",
