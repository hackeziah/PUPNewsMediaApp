			 ...
			 <div class="row clearfix">
				...
				<?php foreach ($cat->items as $data) { ?>
					<tr>
						...
						<td><?= ucwords($this->escaper->escapeHtml($data->CategoryName)) ?></td>
  ...
  var table;
     ...
     function detail(CategoryId)
    {
      ...
      $.ajax({
        ...
        url : "<?= $this->url->get('admin/managecategory/detail') ?>/" + CategoryId,
        type: "GET",
        dataType: "JSON",
    ...
    function deleteCat(CategoryId){
            ...
            {
                  $.ajax({
                    url : "<?= $this->url->get('admin/managecategory/deleteCat') ?>/" + CategoryId,         
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {   
