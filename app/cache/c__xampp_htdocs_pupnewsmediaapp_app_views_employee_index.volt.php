...
<script type="text/javascript">
  ...
  var table;
    ...
    function add_emp()
    {
      ...
      $('#modal_form').modal('show'); // show bootstrap modalsodal
     ...
     function detail(id)
    {
      ...
      $.ajax({
        ...
        url : "<?= $this->url->get('employee/detail') ?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?= $this->url->get('employee/create') ?>";

      }
      
      // else
      // {
      //   url = "<?= $this->url->get('employee/edit') ?>";
    ...
    function deleteEmp(id){
            ...
            {
                  $.ajax({
                    url : "<?= $this->url->get('employee/deleteEmp') ?>/" + id,         
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {   
