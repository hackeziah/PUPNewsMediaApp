            ...
            <div class="row clearfix">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                  ...
                  <div class="body">
                   <?php foreach ($annouces->items as $data) { ?>
               ...
               <ul class="pagination pull-right">
                <li><?= $this->tag->linkTo(['admin/manageannouncements/announcements', 'First']) ?></li>
                <li><?= $this->tag->linkTo(['admin/manageannouncements/announcements?page=' . $annouces->before, 'Previous']) ?></li>
                <li><?= $this->tag->linkTo(['admin/manageannouncements/announcements?page=' . $annouces->next, 'Next']) ?></li>
                <li><?= $this->tag->linkTo(['admin/manageannouncements/announcements?page=' . $annouces->last, 'Last']) ?></li>
              </ul>
            </div>
          </div>
        </div>
